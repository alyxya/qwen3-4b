...
def main():
    ...
    system_prompt = """You are a calculator assistant. When users ask mathematical questions, call the appropriate tool.
...
For complex calculations, you can chain multiple tool calls by calling one tool, receiving the result, then calling another."""
